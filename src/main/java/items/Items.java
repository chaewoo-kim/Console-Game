...
public class Items {
    ...
    public Items() {
        ...
        armor.put(3, new Item("마법사 기본무기", 5, ItemType.ARMOR));
        armor.put(4, new Item("궁수 기본무기", 5, ItemType.ARMOR));
        armor.put(5, new Item("전사 히든무기", 8, ItemType.UNIQUE));
        armor.put(6, new Item("마법사 히든무기", 8, ItemType.UNIQUE));
        armor.put(7, new Item("궁수 히든무기", 8, ItemType.UNIQUE));
